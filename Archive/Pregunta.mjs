export const preguntas = [
    ...
    {
      level: 1,
      question: "The city of Nice is located in",
      correct: "France",
      option1: "Germany",
      option2: "Italy",
      option3: "Spain"
    ...
    {
      level: 1,
      question: "The human beings lives on",
      correct: "earth",
      option1: "moon",
      option2: "mars",
      option3: "saturn"
    ...
    {
      level: 2,
      question: "Which continent is larger?",
      correct: "Asia",
      option1: "Africa",
      option2: "Europe",
      option3: "Oceania"
    ...
    {
      level: 2,
      question: "Most populated city in Colombia?",
      correct: "Bogota",
      option1: "Medellin",
      option2: "Cali",
      option3: "Cartagena"
    ...
    {
      level: 2,
      question: "Recomended hours of sleep",
      correct: 8,
      option1: 6,
      option2: 12,
      option3: 4
    ...
    {
      level: 3,
      question: "Largest Planet on the solar system",
      correct: "Jupiter",
      option1: "Uranus",
      option2: "Mercury",
      option3: "Saturn"
    ...
    {
      level: 3,
      question: "Heaviest element in the periodic table",
      correct: "Oganesson",
      option1: "Radon",
      option2: "Polonium",
      option3: "Mercury"
    ...
    {
      level: 3,
      question: "Number of electrons on a Higrogen Atom",
      correct: 1,
      option1: 2,
      option2: 3,
      option3: 4
    ...
    {
      level: 3,
      question: "In which country is located Taj mahal",
      correct: "India",
      option1: "China",
      option2: "Taiwan",
      option3: "Russia"
    ...
    {
      level: 4,
      question: "Most used OS in the world?",
      correct: "Windows",
      option1: "Linux",
      option2: "MacOS",
      option3: "ChromeOS"
    ...
    {
      level: 4,
      question: "how many stars have European union flag",
      correct: 12,
      option1: 10,
      option2: 20,
      option3: 18
    ...
    },
    {
      ...
      correct: "Expansion of space-time",
      option1: "photons",
      option2: "nothing",
      option3: "Singularity"
    },
